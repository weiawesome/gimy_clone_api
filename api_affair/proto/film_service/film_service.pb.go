...
var file_proto_film_service_proto_rawDesc = []byte{
	...
	0x9a, 0x07, 0x0a, 0x04, 0x46, 0x69, 0x6c, 0x6d, 0x12, 0x49, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x42,
...
var file_proto_film_service_proto_depIdxs = []int32{
	...
	11, // 32: film.Film.AddFilmToSearchEngine:input_type -> film.FilmSpecificRequest
	11, // 33: film.Film.AddFilmPopularity:input_type -> film.FilmSpecificRequest
	10, // 34: film.Film.GetBasicFilms:output_type -> film.FilmInformationListReply
	10, // 35: film.Film.GetPopularTypeFilms:output_type -> film.FilmInformationListReply
	10, // 36: film.Film.GetPopularCategoryFilms:output_type -> film.FilmInformationListReply
	17, // 37: film.Film.GetRankedFilms:output_type -> film.FilmRankedReply
	10, // 38: film.Film.GetFilterFilms:output_type -> film.FilmInformationListReply
	14, // 39: film.Film.GetSpecificFilm:output_type -> film.FilmSpecificReply
	13, // 40: film.Film.GetSpecificFilmRoutes:output_type -> film.FilmSpecificRoutesReply
	20, // 41: film.Film.GetSearchFilms:output_type -> film.FilmSearchReply
	24, // 42: film.Film.SaveFilm:output_type -> google.protobuf.Empty
	24, // 43: film.Film.SaveFilmEpisode:output_type -> google.protobuf.Empty
	24, // 44: film.Film.AddFilmToSearchEngine:output_type -> google.protobuf.Empty
	24, // 45: film.Film.AddFilmPopularity:output_type -> google.protobuf.Empty
